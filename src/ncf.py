...
# Spatial/temporal mutes + spatial taper live in src.mask (single source of
# truth); ncf.py and mask.py both apply them, so import rather than duplicate.
from src.mask import (
    apply_inner_spatial_mute,
    apply_time_distance_mute,
    apply_spatial_taper,
)
...
#    (apply_inner_spatial_mute / apply_time_distance_mute / apply_spatial_taper
#     now imported from src.mask -- see the import block at the top.)
# =============================================================================
